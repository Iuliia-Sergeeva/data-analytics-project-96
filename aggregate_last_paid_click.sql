...
--leads_count — количество лидов, которые оставили визиты,
--кликнувшие в этот день с этими метками
--purchases_count — количество успешно закрытых лидов
--(closing_reason = “Успешно реализовано” или status_code = 142)
...
--Создать и написать для агрегации данных из
--модели атрибуции Last Paid Click aggregate_last_paid_click.sql
--Сохранить топ-15 записей в aggregate_last_paid_click.csv
--согласно требованиям по сортировке
